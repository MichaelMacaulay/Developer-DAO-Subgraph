...
export function handleSweep20(event: Sweep20Event): void {
  let entity = new Sweep20(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
...
export function handleSweep721(event: Sweep721Event): void {
  let entity = new Sweep721(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity._token = event.params._token
  entity._to = event.params._to
